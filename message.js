...
module.exports = function(
  ...
  var phrazes = [
    ...
    'я начинаю нервничать. А когда я нервничаю, я начинаю бояться. А когда охуенному' +
    'пацану становится страшно, он может застрелить каких-нибудь ' +
     ...
     'самосохранения, давай-ка, блин, бегом приступайте. Я здесь для того, чтобы помогать.' +
